          ...
          {isStripeFullyConnected ? (
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-3 px-4 bg-[#635BFF]/10 hover:bg-[#635BFF]/20 border border-[#635BFF]/30 rounded-lg text-[#A8A3FF] hover:text-white transition-colors"
              ...
              >
                ...
                <span className="font-medium">Open Stripe Dashboard</span>
